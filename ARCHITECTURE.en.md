...
| 7. Legacy Is Not Approval | How can human-authored Markdown remain compatible without being promoted to confirmed durable memory? | Current | [English](./docs/architecture/memory-markdown-compatibility-draft.en.md) · [中文](./docs/architecture/memory-markdown-compatibility-draft.zh-CN.md) |
