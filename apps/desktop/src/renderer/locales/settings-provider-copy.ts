...
const zhCopy = {
  detail: {
    ...
    saveFailed: '保存模型连接失败', connectionDisabled: '无法设为默认',
    ...
    settingsSaved: (name: string) => `${name} 已保存`,
    ...
    advanced: '高级设置', saveSettings: '保存', testing: '测试中…', testConnection: '测试连接', updating: '更新中…',
...
const enCopy: ProviderSettingsCopy = {
  detail: {
    ...
    saveFailed: 'Failed to save model connection', connectionDisabled: 'Cannot set as default',
    ...
    settingsSaved: (name: string) => `${name} saved`,
    ...
    advanced: 'Advanced settings', saveSettings: 'Save', testing: 'Testing…', testConnection: 'Test connection', updating: 'Updating…',
