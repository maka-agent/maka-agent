...
const SETTINGS_NAVIGATION_COPY_BY_LOCALE = {
  zh: {
    ...
    sections: {
      ...
      mcp: { label: 'MCP', description: '连接本地或远程 MCP server，为 Maka 动态扩展工具。' },
  ...
  en: {
    ...
    sections: {
      ...
      mcp: { label: 'MCP', description: 'Connect local or remote MCP servers to extend Maka with dynamic tools.' },
