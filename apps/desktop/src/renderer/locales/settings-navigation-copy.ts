...
const SETTINGS_NAVIGATION_COPY_BY_LOCALE = {
  zh: {
    ...
    sections: {
      ...
      skills: { label: '技能', description: '启用内置模板，并检查当前发现的 Skill。' },
      mcp: { label: 'MCP', description: '配置全局 MCP 服务，并检查连接与工具状态。' },
  ...
  en: {
    ...
    sections: {
      ...
      skills: { label: 'Skills', description: 'Activate built-in templates and inspect discovered Skills.' },
      mcp: { label: 'MCP', description: 'Configure global MCP servers and inspect connection and tool status.' },
