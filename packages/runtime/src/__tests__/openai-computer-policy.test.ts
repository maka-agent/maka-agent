...
test('OpenAI computer policy stays separate from user input and stable across continuation', () => {
  ...
  assert.match(initial.instructions, /observation-only/);
  assert.match(initial.instructions, /Accessibility-first element actions/);
