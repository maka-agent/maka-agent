...
const SKILLS_COPY = {
  zh: {
    ...
    activation: { action: (name) => `审查 ${name}`, enable: '启用到 Maka', activeTitle: '已启用到 Maka 工作区', active: '已启用', attention: '需要处理', available: '可启用', scopeHelp: '启用后会创建 Maka 全局工作区副本，对所有项目生效；项目级同名 Skill 仍可覆盖它。', review: '模板审查', confirm: '确认启用到 Maka', close: '关闭', target: '目标位置', requestedTools: '声明工具', requiredTools: '必需工具', requiredCapabilities: '必需能力', none: '无', permissionNotice: '声明或必需工具不会自动获得权限，仍受当前会话权限策略约束。', activeHelp: '该模板已经在 Maka 工作区中存在。', attentionHelp: 'Maka 工作区副本存在配置或状态问题，请到“已发现”查看诊断。' },
    ...
    page: { title: '技能', subtitle: '查看 Maka 当前能发现的 Skill，并诊断来源、覆盖关系与可用性。', actions: '技能操作', search: '搜索技能', openFolder: '打开目录', creating: '创建中…', createExample: '创建示例', add: '添加', refreshing: '刷新中…', refresh: '刷新' },
  },
  en: {
    ...
    activation: { action: (name) => `Review ${name}`, enable: 'Enable in Maka', activeTitle: 'Enabled in the Maka workspace', active: 'Enabled', attention: 'Needs attention', available: 'Available', scopeHelp: 'Enabling creates a copy in the global Maka workspace for every project. A project Skill with the same id can still override it.', review: 'Template review', confirm: 'Confirm enable in Maka', close: 'Close', target: 'Target', requestedTools: 'Declared tools', requiredTools: 'Required tools', requiredCapabilities: 'Required capabilities', none: 'None', permissionNotice: 'Declared or required tools do not gain permission automatically and remain subject to the current session policy.', activeHelp: 'This template already exists in the Maka workspace.', attentionHelp: 'The Maka workspace copy has a configuration or state problem. See Discovered for diagnostics.' },
    ...
    page: { title: 'Skills', subtitle: 'Inspect the Skills Maka can currently discover and diagnose their source, precedence, and availability.', actions: 'Skill actions', search: 'Search skills', openFolder: 'Open folder', creating: 'Creating…', createExample: 'Create example', add: 'Add', refreshing: 'Refreshing…', refresh: 'Refresh' },
  },
