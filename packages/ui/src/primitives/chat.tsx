...
const previewVariants = cva("", {
  variants: {
    part: {
      ...
      // The text-kind result body (#546 PR6): same height-bounded scroll box
      // as the overlay, but no font/white-space utilities — the call site
      // composes the `.maka-prose` class alongside this variant, and the
      // prose layer owns the typography (utilities here would beat it in the
      // cascade).
