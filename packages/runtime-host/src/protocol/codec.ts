...
export function requireUtf8BoundedString(value: unknown, label: string, maxBytes: number): string {
  if (
    typeof value !== 'string' ||
    value.length === 0 ||
...
export function requirePositiveCount(value: unknown, label: string): number {
