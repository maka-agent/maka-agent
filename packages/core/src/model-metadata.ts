...
const ANTHROPIC_MODELS_DEV_METADATA: Record<string, ModelMetadata> = {
  ...
  'claude-sonnet-4-5': { displayName: 'Claude Sonnet 4.5 (latest)', lifecycle: 'active', docsUrl: 'https://docs.anthropic.com/en/docs/about-claude/models/overview', contextWindow: 200_000, maxOutputTokens: 64_000, capabilities: REASONING_FUNCTION_CALLING , thinkingOptions: { toggle: true }},
  'claude-sonnet-4-5-20250929': { displayName: 'Claude Sonnet 4.5', lifecycle: 'active', docsUrl: 'https://docs.anthropic.com/en/docs/about-claude/models/overview', contextWindow: 200_000, maxOutputTokens: 64_000, capabilities: REASONING_FUNCTION_CALLING , thinkingOptions: { toggle: true }},
  'claude-opus-4-1-20250805': { displayName: 'Claude Opus 4.1', lifecycle: 'active', docsUrl: 'https://docs.anthropic.com/en/docs/about-claude/models/overview', contextWindow: 200_000, maxOutputTokens: 32_000, capabilities: REASONING_FUNCTION_CALLING , thinkingOptions: { toggle: true }},
  'claude-haiku-4-5': { displayName: 'Claude Haiku 4.5 (latest)', lifecycle: 'active', docsUrl: 'https://docs.anthropic.com/en/docs/about-claude/models/overview', contextWindow: 200_000, maxOutputTokens: 64_000, capabilities: REASONING_FUNCTION_CALLING , thinkingOptions: { toggle: true }},
  'claude-haiku-4-5-20251001': { displayName: 'Claude Haiku 4.5', lifecycle: 'active', docsUrl: 'https://docs.anthropic.com/en/docs/about-claude/models/overview', contextWindow: 200_000, maxOutputTokens: 64_000, capabilities: REASONING_FUNCTION_CALLING , thinkingOptions: { toggle: true }},
...
const GOOGLE_MODELS_DEV_METADATA: Record<string, ModelMetadata> = {
  ...
  'gemini-2.5-flash': { displayName: 'Gemini 2.5 Flash', lifecycle: 'active', docsUrl: 'https://ai.google.dev/gemini-api/docs/models', contextWindow: 1_048_576, maxOutputTokens: 65_536, capabilities: REASONING_FUNCTION_CALLING , thinkingOptions: { toggle: true }},
