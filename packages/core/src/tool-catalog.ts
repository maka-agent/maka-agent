...
export const MAKA_CATALOG_TOOLS: readonly CatalogToolDef[] = Object.freeze(
  [
    ...
    { name: 'SkillSearch' },
    { name: 'WebSearch' },
    { name: 'memory_remember', effects: ['write'] as const },
    { name: 'memory_extract', effects: ['write'] as const },
    { name: 'memory_evidence_search', effects: ['read'] as const },
    { name: 'memory_evidence_read', effects: ['read'] as const },
    { name: 'memory_submit', effects: ['write'] as const },
