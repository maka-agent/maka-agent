...
export type {
  ...
  LocalMemoryOrigin,
  LocalMemoryApprovalState,
  LocalMemoryCompatibilitySource,
  LocalMemoryCompatibilityStatus,
  LocalMemoryMigrationState,
  LocalMemoryParseResult,
  LocalMemorySettings,
  LocalMemoryScope,
  LocalMemorySource,
  LocalMemorySourceRef,
  LocalMemorySourceRefKind,
  LocalMemoryState,
  LocalMemoryAgentReadContext,
  LocalMemoryAgentReadEmptyReason,
