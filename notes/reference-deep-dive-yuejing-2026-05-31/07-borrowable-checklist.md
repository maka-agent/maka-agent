...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:50582-50620` (`wk()` helper) and `62807-62830` (callsite). Stamps `providerOptions: { anthropic: { cacheControl: { type: "ephemeral" } } }` on first 2 system messages + last 2 non-system. System prompt split at `"SYSTEM INFO"` line.
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:24631-24684` (Skill tool execute). Returns raw markdown with absolute-path preamble; only name + 1-liner in system prompt.
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:50318-50321` (setter in `nk()`), `63113` (closure init), `63130, 63147, 63120, 63267, 62945` (resetters). Long-running tools can reset the inactivity watchdog.
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:62947-62968` + `61582-61600` (multi-turn persistence). Dynamic tool surface — model calls ToolSearch, results merge into `activeTools` for next steps.
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:24058` (Read), `27865` (BrowserScreenshot), `28677-28741` (ChromeRelayScreenshot). Per-tool hook converts return value to chat parts (text + image).
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:50566-50573` (the `fk` provider-options map).
- **Maka**: same as #1.
- **Scope**: S
- **Status**: covered by #1.
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:61758`. Slot above personality with header `SECURITY RULES (HIGHEST PRIORITY — overrides all other instructions):`.
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:23350-23365` — `CI: "1"`, `DEBIAN_FRONTEND: "noninteractive"`, `ALMA_THREAD_ID`, `ALMA_CHAT_ID`, `RTK_DB_PATH`.
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:49994` (`zE` predictor), `50211` (`ZE` compactor), `62998-63095` (in-loop), `50071` (`KE` pre-flight). The cache-aware `WE` token sum at `49989` is essential.
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:62478-62620` (full branch tree).
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:23274` (background path), `23369-23523` (3-tier kill timer), `24557` (BashOutput tool).
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:24379-24400`.
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:24058`.
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:64068-64313` (`y()`).
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:19147` (`Vu.getOrCreateMapping`); schema at `~/Downloads/reference-source/docs/08-memory.md §3.10`.
...
- **Yetone**: 38 `generateText` sites in `~/Downloads/reference-source/docs/31-llm-calls.md` (or `~/Downloads/reference-source/readable/main.js:14860, 32922, 33624, 33776, 33823, 36614, 36664, 38187, 59865`).
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js` (search `summarizeAndStoreMemories`); per `01-agent-loop.md §14 step 13`.
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:61582-61630`.
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:63460-63478`.
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:61972` reinjects in user turns.
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:19345-19400`.
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:61741` (SOUL "Evolved Traits" pattern).
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:34696, 37952, 40536`.
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:34612, 36570, 37930`.
...
- **Yetone**: USER.md format per `~/Downloads/reference-source/docs/08-memory.md §7.3`.
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:35075, 35107`.
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:23350-23365`.
...
- **Yetone**: per `~/Downloads/reference-source/docs/16-bots.md §10`.
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:18705`.
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:61712`.
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:71598-71628`.
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:26302-26472`.
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:62970-62997`.
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:32950, 33027, 33072`.
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:58412-58420, 60695-60707`.
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:56912`.
...
- **Yetone**: `~/Downloads/reference-source/readable/main.js:22136`.
...
| `cleanupLegacyBundledSkills` destructive delete | Per `~/Downloads/reference-source/docs/21-skill-install.md §1`, this silently deletes user-edited copies. |
| Asymmetric skill override (bundled is sticky to some sources but not others) | Per `~/Downloads/reference-source/docs/21-skill-install.md §1.loadSkills`, probably a bug. If we mirror, mirror symmetrically. |
