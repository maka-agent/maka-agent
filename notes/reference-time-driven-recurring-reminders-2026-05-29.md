# Reference app Time-Driven Deep Dive -> Maka Plan Reminder PR

Date: 2026-05-29
Owner: kenji
Source project: `/Users/jakevin/reference-source`
...
- Related prior Reference app notes in `docs/16-bots.md`, `docs/57-telegram-deep.md`, and existing Maka plan-reminder implementation.

## Reference app Details Worth Copying

Reference app's scheduler is broader than a reminder feature:
...
This PR copies the lowest-risk part of Reference app first: recurring schedule semantics and run preservation. It intentionally does not copy AI auto-execution or platform delivery yet.
...
These are useful Reference app ideas, but should be separate PRs:
