...
Remote OAuth revocation is not required for this PR because Anthropic does not expose a public RFC 7009 revocation endpoint as of 2026-05-28. Alma's `ld.logout` path also local-clears only (`~/Downloads/alma-re/readable/main.js:16280-16295`). Do not call non-public or guessed revocation endpoints.
