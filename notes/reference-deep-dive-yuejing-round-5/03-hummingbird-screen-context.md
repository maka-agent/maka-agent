# 03 — Reference app Hummingbird: Quick Chat screen-context capture
...
(global keyboard shortcut), reference app captures three things:
...
Reference app uses the same naming convention so that if the model has
...
Computer Use (round-2 [`01-computer-use.md`](../reference app-deep-dive-yuejing-round-2/01-computer-use.md))
...
- LittleBird is an Apple Intelligence convention. Does reference app's
...
- Round 2: [`01-computer-use.md`](../reference app-deep-dive-yuejing-round-2/01-computer-use.md)
