# 04 — Reference app permissions runtime: autoApprove + 5 bypass channels + Bash's AI risk analyzer

> Source-grounded against `~/Downloads/reference-source/readable/main.js`.
> Pinned open question in round-2 [`04-permissions-runtime.md`](../reference app-deep-dive-yuejing-round-2/04-permissions-runtime.md):
...
orchestration.md`](../reference app-deep-dive-yuejing-round-2/07-subagent-orchestration.md).
...
The reference app binary model + analyzer + bypass-channels combo is the
...
3. **Subagent bypass channel.** Cheapest win: a `metadata.isSubagent`
   ...
   reference app subagent system lands (round-2 note 07).
