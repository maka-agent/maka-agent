# Reference app deep-dive round 3 — yuejing

Round 1 (`notes/reference app-deep-dive-yuejing-2026-05-31/`) covered the agent
loop, tools registry, prompts/skills, memory, renderer architecture,
bots, and 40+ borrowable patterns.

Round 2 (`notes/reference app-deep-dive-yuejing-round-2/`) added 11 source-
...
| 02 | `02-output-safety-modes.md` | 3-mode classifier (exact/compact/passthrough) + 8 budget profiles + `[reference app-output-safety: …]` marker + truncation cascade with recovery hints + outer shrink loop | **shipped** |
...
- **Output safety modes** (`[reference app-output-safety: exact|compact|
