...
| 7. Legacy Is Not Approval | 人工 Markdown 如何兼容读取，又不被误提升为已确认 durable memory？ | Current | [中文](./docs/architecture/memory-markdown-compatibility-draft.zh-CN.md) · [English](./docs/architecture/memory-markdown-compatibility-draft.en.md) |
